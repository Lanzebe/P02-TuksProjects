...
UPW_LC1.plot_beam_diagrams( save=True)
...
for idx,i in enumerate(SpanThicknessPos):
    ...
    Height_y = Height/2
    WidthsForLoadcases = [(12*Height_y*UPW_LC1.EIv_prime2(i)/Sigma_yeild)/(Height**3 - (Height - 2*Thickness)**3)]
...
#joblib.dump([SpanThicknessPos,IValue], "C:\\Users\\ebers\\Documents\\GitHub Repositories\\P02-TuksProjects\\Y4-MLV420\\SparDesign\\IvalueData2.txt")
